...
<div class="d-flex flex-column" data-scroll-to-active="true" style="  height:100vh;width:20vw;">
  ...
  <div class="menu-item d-flex flex-column align-items-center justify-content-around" style="width:100%;height:65%;">
    <div><a href="<?=base_url('pegawai/dashboard')?>">Dashboard</a></div>
    <div><a href="<?=base_url('pegawai/reservasi')?>">Reservation</a></div>
    <div><a href="<?=base_url('pegawai/layanan')?>">Service</a></div>
    <div><a href="<?=base_url('pegawai/pasien')?>">Patient</a></div>
    <div><a href="<?=base_url('pegawai/terapis')?>">Terapist</a></div>
    <div><a href="<?=base_url('pegawai/jadwal')?>">Practice Schedule</a></div>
  </div>
</div>
  <!-- BEGIN: Content-->
