...
<div class="d-flex flex-column" data-scroll-to-active="true" style="  height:100vh;width:20vw;">
  ...
  <div class="menu-item d-flex flex-column align-items-center justify-content-around" style="width:100%;height:25%;">
    <div><a href="<?=base_url('pelanggan/reservasi')?>">Reservation</a></div>
    <div><a href="<?=base_url('pelanggan/layanan')?>">Service</a></div>
    <div><a href="<?=base_url('pelanggan/jadwal')?>">Practice Schedule</a></div>
  </div>
</div>
