          ...
          <div class="row" >
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-5" style="background-color: white;">
                <div class="card-header pb-0 text-left bg-transparent">
                  ...
                  <h2 class="mb-0 #9F481B" >Sign In</h2>
                </div>
                <div class="card-body">
            ...
            <div class="col-md-6">
              <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8"
                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-size: 90% 100%; background-repeat: no-repeat; background-image:url('../../../assets/img/loginr.JPG')"></div>
              </div>
            </div>
          </div>
        </div>
