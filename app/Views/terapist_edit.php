...
<section>
    ...
    <h1 style="position:relative;left:-20%;">Edit Terapist</h1>
    <br><br>
    <form method="POST" action="<?= base_url('/terapis/edit/' . $terapis['id'])?>" enctype="multipart/form-data" style="width: 100%;">
    <input type="hidden" name="_method" value="PUT">
                ...
                <button class="mt-3" type="submit" style="background-color: #9F481B;width:100%; color: #fff; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer;">Update Terapist</button>
        </form>
    </div>
</section>
<?= $this->endSection() ?>
