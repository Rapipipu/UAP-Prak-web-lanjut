...
<section>
    ...
    <br><br>
        <form action="<?= base_url('/layanan/store') ?>" method="post" style="width: 100%; max-width: 400px;">
            <label for="nama" style="font-size: 18px; font-weight: bold; margin-bottom: 10px; display: block;">Service:</label>
            <input type="text" name="service" required style="width: 100%; padding: 10px; border: 1px solid #ced4da; border-radius: 5px; margin-bottom: 20px;">
            

            <label for="umur" style="font-size: 18px; font-weight: bold; margin-bottom: 10px; display: block;">Price:</label>
            <input type="text" name="price"  required style="width: 100%; padding: 10px; border: 1px solid #ced4da; border-radius: 5px; margin-bottom: 20px;">
            <br><br><br><br>
