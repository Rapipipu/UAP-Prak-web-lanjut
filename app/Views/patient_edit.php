...
<section>
    <div class="d-flex" style="position: absolute; top: 0%; width: 30%; height:100vh;left: 40%; background: #f8f9fa; padding: 50px; border-radius: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); display: flex; flex-direction: column; align-items: center;">
    ...
    <?php if(null!=(session('errors'))){
       ...
       dd(session('errors'));
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <input type="text" name="poin" value="<?= $pasien['poin'] ?>" required style="width: 100%; padding: 10px; border: 1px solid #ced4da; border-radius: 5px;">
                </div>
